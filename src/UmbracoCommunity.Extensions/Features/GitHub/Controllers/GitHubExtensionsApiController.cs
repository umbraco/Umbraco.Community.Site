...
using UmbracoCommunity.Extensions.Features.GitHub.Models;
...
namespace UmbracoCommunity.Extensions.Features.GitHub.Controllers;

[ApiVersion("1.0")]
[ApiExplorerSettings(GroupName = "UmbracoCommunity.Extensions")]
public class GitHubExtensionsApiController : UmbracoCommunityExtensionsApiControllerBase
{
    private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;
    private readonly GitHubSqlStore _dataStore;
    private readonly GitHubSyncOptions _syncOptions;

    public GitHubExtensionsApiController(
    ...
    #region Example/Test Endpoints

    [HttpGet("ping", Name = "Ping")]
    [ProducesResponseType<string>(StatusCodes.Status200OK)]
    public string Ping() => "Pong";

    [HttpGet("whatsTheTimeMrWolf", Name = "WhatsTheTimeMrWolf")]
    [ProducesResponseType(typeof(DateTime), 200)]
    public DateTime WhatsTheTimeMrWolf() => DateTime.Now;

    [HttpGet("whatsMyName", Name = "WhatsMyName")]
    [ProducesResponseType<string>(StatusCodes.Status200OK)]
    ...
    [HttpGet("hqmembers", Name = "GetHqMembers")]
    ...
    [HttpGet("download-hqmembers", Name = "DownloadHqMembers")]
    ...
    [HttpGet("hqmembers/{id}", Name = "GetHqMember")]
    ...
    [HttpPost("hqmembers", Name = "CreateHqMember")]
    ...
    [HttpPut("hqmembers/{id}", Name = "UpdateHqMember")]
    [ProducesResponseType<GitHubHqMember>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    ...
    [HttpDelete("hqmembers/{id}", Name = "DeleteHqMember")]
    ...
    [HttpPost("hqmembers/import", Name = "ImportHqMembers")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    ...
    [HttpPost("import-sample-hq-members", Name = "ImportSampleHqMembers")]
    ...
    [HttpGet("export-github-data", Name = "ExportGitHubData")]
    ...
    [HttpGet("download-github-data", Name = "DownloadGitHubData")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    ...
    [HttpPost("import-github-data", Name = "ImportGitHubData")]
    ...
    [HttpPost("import-sample-github-data", Name = "ImportSampleGitHubData")]
    [AllowAnonymous] // Allow for testing - remove in production
    [ProducesResponseType<SampleDataImportResult>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [HttpGet("contributions", Name = "GetContributionStats")]
